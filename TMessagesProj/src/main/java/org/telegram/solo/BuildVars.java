...
public class BuildVars {
    ...
    public static int APP_ID = 25103540;
    public static String APP_HASH = "cda0478b154e80f6482c262a346988ce";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.telegram.solo.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
