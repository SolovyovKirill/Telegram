...
-keep class org.telegram.solo.* { *; }
-keep class org.telegram.solo.camera.* { *; }
-keep class org.telegram.solo.secretmedia.* { *; }
-keep class org.telegram.solo.support.* { *; }
-keep class org.telegram.solo.support.* { *; }
-keep class org.telegram.solo.time.* { *; }
-keep class org.telegram.solo.video.* { *; }
-keep class org.telegram.solo.voip.* { *; }
