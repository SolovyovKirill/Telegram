...
void initWebRTC(JNIEnv *env) {
    ...
    NativeInstanceClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("org/telegram/solo/voip/NativeInstance")));
    DEBUG_REF("TrafficStatsClass");
    TrafficStatsClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("org/telegram/solo/voip/Instance$TrafficStats")));
    DEBUG_REF("FingerprintClass");
    FingerprintClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("org/telegram/solo/voip/Instance$Fingerprint")));
    DEBUG_REF("FinalStateClass");
    FinalStateClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("org/telegram/solo/voip/Instance$FinalState")));
    FinalStateInitMethod = env->GetMethodID(FinalStateClass, "<init>", "([BLjava/lang/String;Lorg/telegram/solo/voip/Instance$TrafficStats;Z)V");
}

extern "C"
JNIEXPORT jlong JNICALL Java_org_telegram_solo_voip_NativeInstance_makeGroupNativeInstance(JNIEnv *env, jclass clazz, jobject instanceObj, jstring logFilePath, jboolean highQuality, jlong videoCapturer, jboolean screencast, jboolean noiseSupression) {
    initWebRTC(env);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setJoinResponsePayload(JNIEnv *env, jobject obj, jstring payload) {
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_prepareForStream(JNIEnv *env, jobject obj, jboolean isRtmpStream) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_resetGroupInstance(JNIEnv *env, jobject obj, jboolean set, jboolean disconnect) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setNoiseSuppressionEnabled(JNIEnv *env, jobject obj, jboolean enabled) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_org_telegram_solo_voip_NativeInstance_addIncomingVideoOutput(JNIEnv *env, jobject obj, jint quality, jstring endpointId, jobjectArray ssrcGroups, jobject remoteSink) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return 0;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_removeIncomingVideoOutput(JNIEnv *env, jobject obj, jlong nativeRemoteSink) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setVideoEndpointQuality(JNIEnv *env, jobject obj, jstring endpointId, jint quality) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_org_telegram_solo_voip_NativeInstance_makeNativeInstance(JNIEnv *env, jclass clazz, jstring version, jobject instanceObj, jobject config, jstring persistentStateFilePath, jobjectArray endpoints, jobject proxyClass, jint networkType, jobject encryptionKey, jobject remoteSink, jlong videoCapturer, jfloat aspectRatio) {
    initWebRTC(env);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setGlobalServerConfig(JNIEnv *env, jobject obj, jstring serverConfigJson) {
    SetLegacyGlobalServerConfig(tgvoip::jni::JavaStringToStdString(env, serverConfigJson));
}

extern "C"
JNIEXPORT jstring JNICALL Java_org_telegram_solo_voip_NativeInstance_getVersion(JNIEnv *env, jobject obj) {
    return env->NewStringUTF(tgvoip::VoIPController::GetVersion());
}

extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setBufferSize(JNIEnv *env, jobject obj, jint size) {
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setNetworkType(JNIEnv *env, jobject obj, jint networkType) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setMuteMicrophone(JNIEnv *env, jobject obj, jboolean muteMicrophone) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setVolume(JNIEnv *env, jobject obj, jint ssrc, jdouble volume) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setAudioOutputGainControlEnabled(JNIEnv *env, jobject obj, jboolean enabled) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setEchoCancellationStrength(JNIEnv *env, jobject obj, jint strength) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jstring JNICALL Java_org_telegram_solo_voip_NativeInstance_getLastError(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jstring JNICALL Java_org_telegram_solo_voip_NativeInstance_getDebugInfo(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_org_telegram_solo_voip_NativeInstance_getPreferredRelayId(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return 0;
    }
...
extern "C"
JNIEXPORT jobject JNICALL Java_org_telegram_solo_voip_NativeInstance_getTrafficStats(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jbyteArray JNICALL Java_org_telegram_solo_voip_NativeInstance_getPersistentState(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_stopNative(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return;
    }
    instance->nativeInstance->stop([instance](const FinalState& finalState) {
        ...
        env->CallVoidMethod(globalRef, env->GetMethodID(NativeInstanceClass, "onStop", "(Lorg/telegram/solo/voip/Instance$FinalState;)V"), asJavaFinalState(env, finalState));
        delete instance;
    });
}

extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_stopGroupNative(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_onStreamPartAvailable(JNIEnv *env, jobject obj, jlong ts, jobject byteBuffer, jint size, jlong responseTs, jint videoChannel, jint quality) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_onMediaDescriptionAvailable(JNIEnv *env, jobject obj, jlong taskPtr, jintArray ssrcs) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_org_telegram_solo_voip_NativeInstance_createVideoCapturer(JNIEnv *env, jclass clazz, jobject localSink, jint type) {
    initWebRTC(env);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_activateVideoCapturer(JNIEnv *env, jobject obj, jlong videoCapturer) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_clearVideoCapturer(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance) {
        instance->nativeInstance->setVideoCapture(nullptr);
    } else if (instance->groupNativeInstance) {
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_destroyVideoCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer) {
    auto capturer = reinterpret_cast<VideoCaptureInterface *>(videoCapturer);
    delete capturer;
}

extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_switchCameraCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer, jboolean front) {
    auto capturer = reinterpret_cast<VideoCaptureInterface *>(videoCapturer);
    capturer->switchToDevice(front ? "front" : "back", false);
}

extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setVideoStateCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer, jint videoState) {
    auto capturer = reinterpret_cast<VideoCaptureInterface *>(videoCapturer);
    capturer->setState(static_cast<VideoState>(videoState));
}

extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_switchCamera(JNIEnv *env, jobject obj, jboolean front) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT jboolean JNICALL Java_org_telegram_solo_voip_NativeInstance_hasVideoCapturer(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->_videoCapture == nullptr) {
        return JNI_FALSE;
    }
...
extern "C"
JNIEXPORT void Java_org_telegram_solo_voip_NativeInstance_setVideoState(JNIEnv *env, jobject obj, jint state) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setupOutgoingVideo(JNIEnv *env, jobject obj, jobject localSink, jint type) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_setupOutgoingVideoCreated(JNIEnv *env, jobject obj, jlong videoCapturer) {
    if (videoCapturer == 0) {
        return;
    }
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_onSignalingDataReceive(JNIEnv *env, jobject obj, jbyteArray value) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_telegram_solo_voip_NativeInstance_onRequestTimeComplete(JNIEnv *env, jobject obj, jlong taskPtr, jlong currentTime) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
