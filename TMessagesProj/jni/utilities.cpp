...
extern "C" JNIEXPORT jstring Java_org_telegram_solo_Utilities_readlink(JNIEnv *env, jclass clazz, jstring path) {
...
extern "C" JNIEXPORT jstring Java_org_telegram_solo_Utilities_readlinkFd(JNIEnv *env, jclass clazz, int fd) {
...
Java_org_telegram_solo_Utilities_setupNativeCrashesListener(JNIEnv *env, jclass clazz,
                                                                 jstring path) {
